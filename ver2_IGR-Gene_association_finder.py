...
if dataset == "both":
    igrcsv = "C:\\Users\\david\\Documents\\3rd Year\\INTERNSHIP\\GENOMES\\piggy_out_BOTHGEN\\IGR_presence_absence().csv"
    outputtextfile = open("C:\\Users\\david\\Documents\\3rd Year\\INTERNSHIP\\GENOMES\\piggy_out_BOTHGEN\\IGR-Gene associations per genome(2)", "w")
elif dataset == "comp":
    igrcsv = "C:\\Users\\david\\Documents\\3rd Year\\INTERNSHIP\\GENOMES\\piggy_out_COMPGEN\\IGR_presence_absence.csv"
    outputtextfile = open("C:\\Users\\david\\Documents\\3rd Year\\INTERNSHIP\\GENOMES\\piggy_out_COMPGEN\\IGR-Gene associations per genome(2)", "w")
else:
    igrcsv = dataset
    outputtextfile = open(dataset + "\\IGR-Gene associations per genome", "w")
